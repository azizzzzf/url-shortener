      ...
      <div className="flex-1 container mx-auto px-4 py-12 sm:py-16 md:py-20 relative animate-in fade-in slide-in-from-bottom-8 duration-1000 fill-mode-forwards z-10">
        <div className="max-w-lg mx-auto">
          <div className="text-center space-y-3 mb-10">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#f5f5f0] tracking-tight animate-in fade-in slide-in-from-bottom-4 duration-1000 fill-mode-forwards">
              URL Shortener
            </h1>
            <div className="text-base text-[#e0e0d0]/90 font-medium animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200 fill-mode-forwards">
              <div className="flex items-center justify-center flex-wrap gap-x-1.5">
                ...
                <div className="relative inline-block">
                  ...
                  />
                  <div 
                    className="absolute inset-0 border border-[#e0e0d0]/30 rounded-md bg-[#001a10]/30 backdrop-blur-sm -z-10"
                    style={{ 
                      width: 'calc(100%)',
